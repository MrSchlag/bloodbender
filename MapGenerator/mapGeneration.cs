...
namespace MapGenerator
{
    public class MapGeneration
    {
        ...
        public Room selectRandomEnd()
        {
            int endIndex = rand.Next(0, endRoomFilesWithTopBotEntries.Count);
            Room end = rloader.load(endRoomFilesWithTopBotEntries[endIndex]);
